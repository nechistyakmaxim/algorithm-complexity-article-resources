...
- [[#Введение|Введение]]
- [[#Обзор ключевых классов сложности|Обзор ключевых классов сложности]]
	- [[#Обзор ключевых классов сложности#Константная сложность — O(1)|Константная сложность — O(1)]]
	- [[#Обзор ключевых классов сложности#Линейная сложность — O(n)|Линейная сложность — O(n)]]
	- [[#Обзор ключевых классов сложности#Линейно-логарифмическая сложность — O(n log n)|Линейно-логарифмическая сложность — O(n log n)]]
	- [[#Обзор ключевых классов сложности#Квадратичная сложность — O(n²)|Квадратичная сложность — O(n²)]]
	- [[#Обзор ключевых классов сложности#Экспоненциальная сложность — `O(2^n)`|Экспоненциальная сложность — O(2^n)]]
	- [[#Обзор ключевых классов сложности#Факториальная сложность — `O(n!)`|Факториальная сложность — O(n!)]]
...
> [!NOTE]  Лучший, средний и худший случаи
> 
...
> [!NOTE] Константная сложность. Итог 
> 
...
> [!NOTE] Линейно-логарифмическая сложность. Итог 
> 
...
$$
\sum_{i=0}^{n-1} (n - i - 1) = 1 + 2 + \dots + (n-1) = \frac{n(n-1)}{2}.  
$$
...
$\frac{499500}{4950} \approx 100{,}90909\ldots \ (\approx 100{,}91).$  
...
Мы наблюдаем: 15 → 301 мс, то есть время выросло в ~20 раз:   $\frac{301}{15} \approx 20{,}0666\ldots$  
...
> [!NOTE] Квадратичная сложность. Итог 
> 
...
> [!NOTE] Экспоненциальная сложность. Вывод
> 
...
> [!NOTE] Факториальная сложность. Вывод
> 
